...
// Avoids reliance on the ephemeral Railway filesystem.
...
export async function saveMultipleFiles(formData, field) {
  ...
  for (const file of files) {
    // Use duck-typing instead of instanceof — File global may differ in Node.js versions
    const isFile = file && typeof file === 'object' && typeof file.arrayBuffer === 'function' && file.size > 0;
    if (isFile) {
